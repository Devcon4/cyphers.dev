...
export default class CodeBlockComponent extends LitElement {
  ...
  static styles = css`
  /* PrismJS 1.16.0
	https://prismjs.com/download.html#themes=prism&languages=markup+css+clike+javascript+csharp+bash+aspnet+docker+json+markdown+typescript+sql+wasm&plugins=toolbar+copy-to-clipboard */
	/**
